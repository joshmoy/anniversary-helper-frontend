...
export function Features() {
  return (
    <section className="w-full bg-bg-light py-16 px-8 md:px-16 lg:px-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1280px] mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              <div 
                key={index}
                className="bg-white rounded-xl p-8 flex flex-col gap-4 hover:shadow-lg transition-shadow"
              >
                <Icon width={24} height={24} color={feature.iconColor} />
                <h3 className="text-base font-normal text-text-primary">{feature.title}</h3>
